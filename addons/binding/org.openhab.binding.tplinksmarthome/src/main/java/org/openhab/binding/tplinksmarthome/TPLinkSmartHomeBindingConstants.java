...
public final class TPLinkSmartHomeBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_RE270K = new ThingTypeUID(BINDING_ID, "re270k");
    public static final ThingTypeUID THING_TYPE_RE370K = new ThingTypeUID(BINDING_ID, "re370k");
    ...
    /**
     * All Smart Home on/off devices that also can monitor energy. Only HS100 supports this.
     */
    @SuppressWarnings("null")
    ...
    public static final String CHANNEL_COLOR_TEMPERATURE_PERCENTAGE = "colorTemperaturePercentage";
    ...
    public static final Set<String> CHANNELS_BULB_SWITCH = ImmutableSet.of(CHANNEL_BRIGHTNESS, CHANNEL_COLOR,
            CHANNEL_COLOR_TEMPERATURE, CHANNEL_COLOR_TEMPERATURE_PERCENTAGE, CHANNEL_SWITCH);
