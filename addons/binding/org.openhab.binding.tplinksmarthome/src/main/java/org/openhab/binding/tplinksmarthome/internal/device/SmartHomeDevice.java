...
public abstract class SmartHomeDevice {
     ...
     */
    protected void checkErrors(HasErrorResponse response) throws IOException {
     ...
     * @param tpLinkSmartHomeConfiguration The global configuration
    ...
    public abstract boolean handleCommand(String channelID, Connection connection, Command command,
            @NonNull TPLinkSmartHomeConfiguration configuration) throws IOException;
