...
public enum CosemObjectType {
    ...
    EMETER_VALUE(new OBISIdentifier(0, null, 24, 2, 1, null),
            ...
            new CosemValueDescriptor(CosemDouble.class, "kWh")),
    ...
    EMETER_INSTANT_VOLTAGE_L1(new OBISIdentifier(1, 0, 32, 7, 0, null),
            new CosemValueDescriptor(CosemDouble.class, "V")),
    ...
    GMETER_24H_DELIVERY_COMPENSATED_V2(new OBISIdentifier(7, 0, 23, 2, 0, null),
            new CosemValueDescriptor(CosemString.class, "m3"),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp")),
    GMETER_VALUE_V3(new OBISIdentifier(0, null, 24, 3, 0, null),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp"), // Time stamp off the reading
    ...
    HMETER_EQUIPMENT_IDENTIFIER_V2_2(new OBISIdentifier(5, 0, 0, 0, 0, null),
            new CosemValueDescriptor(CosemString.class, "")),
    HMETER_VALUE_V2(new OBISIdentifier(5, 0, 1, 0, 0, null), new CosemValueDescriptor(CosemDouble.class, "GJ"),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp")),

    /* Cooling Meter */
    CMETER_EQUIPMENT_IDENTIFIER_V2_2(new OBISIdentifier(6, 0, 0, 0, 0, null),
            new CosemValueDescriptor(CosemString.class, "")),
    CMETER_VALUE_V2(new OBISIdentifier(6, 0, 1, 0, 0, null), new CosemValueDescriptor(CosemDouble.class, "GJ"),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp")),

    /* Water Meter */
    WMETER_EQUIPMENT_IDENTIFIER_V2_2(new OBISIdentifier(8, 0, 0, 0, 0, null),
            new CosemValueDescriptor(CosemString.class, "")),
    WMETER_VALUE_V2(new OBISIdentifier(8, 0, 1, 0, 0, null), new CosemValueDescriptor(CosemDouble.class, "m3"),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp")),
    WMETER_VALUE_V3(new OBISIdentifier(0, null, 24, 3, 0, null), new CosemValueDescriptor(CosemDouble.class, "m3")),

    /* M3 Meter (Gas, Water) */
    M3METER_VALUE(new OBISIdentifier(0, null, 24, 2, 1, null),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp"),
            new CosemValueDescriptor(CosemDouble.class, "m3")),

    /* GJ Meter (Heating, Cooling) */
    GJMETER_VALUE_V3(new OBISIdentifier(0, null, 24, 3, 0, null), new CosemValueDescriptor(CosemDouble.class, "GJ")),
    GJMETER_VALUE_V4(new OBISIdentifier(0, null, 24, 2, 1, null),
            new CosemValueDescriptor(CosemDate.class, "", "timestamp"),
            new CosemValueDescriptor(CosemDouble.class, "GJ")),
